...
This is demonstrated in our test suite (468 discovered, 467 passed, 1 skipped):
...
```bash
# Run all tests (468 discovered, 467 passed, 1 skipped)
mvn test
...
**Total: 468 discovered | 467 passed | 1 skipped | BUILD SUCCESS**
